...
At the time of writing, for microlearning modules, there is one Word template used for both the module design and module content. The PjM or MLS will provide the template to the SME. You can find the **Microlearning combined template.dotx** file [in this library ](https://waypointventures.sharepoint.com/sites/Home/Waypoint%20Documents/Forms/AllItems.aspx).
